...
\begin{figure}[H]
\center{\includegraphics[width=1.0\linewidth]{plot1}}
...
\begin{figure}[H]
\center{\includegraphics[width=1.0\linewidth]{plot2}}
\caption{Plotting results.}
\label{fig:plot2}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[width=0.8\linewidth]{plot3}}
\caption{Plotting results.}
\label{fig:plot3}
\end{figure}
\begin{figure}[H]
\center{\includegraphics[width=0.8\linewidth]{plot4}}
\caption{Plotting results.}
\label{fig:plot4}
\end{figure}
